...
public class FormPages extends GenericFunctions {
	...
	public void validateDateOnScreen(String dateOption) {
		if (dateOption.equals("today")) {
			assertVerification(getInputValue(getWebElementBy(flm.getDateSelect()), driver),FormTextsModels.getTodayDate());
		}else {
			assertVerification(getInputValue(getWebElementBy(flm.getDateSelect()), driver),FormTextsModels.getTomorrowDate());
		}
	}
