...
public class FormLocatorsModel {
	...
	private By tittlePopUp = By.id("example-modal-sizes-title-lg");
	private By tablePopUp = By.tagName("table");
	private By buttonClosePopUp = By.id("closeLargeModal");
	...
	public By getButtonClosePopUp() {
		return buttonClosePopUp;
	}
}